package com.mysheng.office.kkanshop.decoration;
...
/**
 * Created by myaheng on 2018/11/12.
 */
...
public class DividerGridItem extends RecyclerView.ItemDecoration  {
     ...
     */
    public DividerGridItem(Context context, int drawableId) {
     ...
     */
    public DividerGridItem(Context context, int dividerHeight, int dividerColor) {
