...
public class ShoppingCartAnimationView extends TextView implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void startBeizerAnimation(TextView textView) {
        if (startPosition == null || endPosition == null) return;
        int pointX = (startPosition.x + endPosition.x) / 2;
        int pointY = (int) (startPosition.y - convertDpToPixel(400, mContext));
        mTextView=textView;
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                int num=Integer.parseInt(mTextView.getText().toString().trim())+1;
