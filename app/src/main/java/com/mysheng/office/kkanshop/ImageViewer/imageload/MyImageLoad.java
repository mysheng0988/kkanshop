...
import com.mysheng.office.kkanshop.ImageViewer.ImageLoad;
...
public class MyImageLoad implements ImageLoad {
    ...
    @Override
    public void loadVideo(String url, LoadCallback callback, VideoView videoView, String uniqueStr) {
    ...
    private void loadImageFromNet(final String url, final String unique, final ImageView imageView) {
        OkHttpImageLoad.ImageDownLoadListener loadListener = new OkHttpImageLoad.ImageDownLoadListener() {
            ...
            public void onSuccess() {
                loadImageFromLocal(KkanApplication.getCachedPath(url), unique, imageView);
            }
     ...
     * 从本地加载视频
     */
    private void loadVideoFromLocal(String url, final String unique, final VideoView videoView) {
