...
/**
 * Created by myaheng on 2018/10/25.
 */

@SuppressLint("AppCompatCustomView")
public class MarqueeTextView extends TextView {
    /** 默认滚动时间 */
    private static final int ROLLING_SPEED_DEFAULT = 5;
    /** 第一次滚动默认延迟 */
...
//                / scrollingLen)).intValue();
        final int duration =mRollingSpeed*scrollingLen;
        if (mFirst) {
    ...
    /** 获取滚动一次的时间 */
    public int getRndSpeed() {return mRollingSpeed;}
    /** 设置滚动一次的时间 */
    public void setRndSpeed(int duration) {this.mRollingSpeed = duration;}
    /** 设置滚动模式 */
