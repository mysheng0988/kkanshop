...
public class CustomProgressBar extends View {
    ...
    private LinearGradient getLinearGradient(){
        if(linearGradient==null){
            linearGradient = new LinearGradient(0, 0, getWidth(), mHeight, new int[]{mContext.getResources().getColor(R.color.green),
                    mContext.getResources().getColor(R.color.red)}, null, Shader.TileMode.CLAMP); //根据R文件中的id获取到color
        }
