 ...
 */
public class ViewLineDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public ViewLineDivider(Context context, int orientation, int drawableId) {
     ...
     * @param orientation 列表方向
     */
    public ViewLineDivider(Context context, int orientation) {
     ...
     */
    public ViewLineDivider(int orientation, int dividerHeight, int dividerColor) {
        if (orientation != LinearLayoutManager.VERTICAL && orientation != LinearLayoutManager.HORIZONTAL) {
            throw new IllegalArgumentException("请输入正确的参数！");
        }
        mOrientation = orientation;
     ...
     * @param dividerColor 分割线颜色
     */
    public ViewLineDivider(int orientation, int dividerColor) {
