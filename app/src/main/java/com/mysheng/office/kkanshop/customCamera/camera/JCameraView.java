package com.mysheng.office.kkanshop.customCamera.camera;
...
import com.mysheng.office.kkanshop.customCamera.camera.lisenter.CaptureLisenter;
import com.mysheng.office.kkanshop.customCamera.camera.lisenter.ErrorLisenter;
import com.mysheng.office.kkanshop.customCamera.camera.lisenter.FirstFoucsLisenter;
import com.mysheng.office.kkanshop.customCamera.camera.lisenter.JCameraLisenter;
import com.mysheng.office.kkanshop.customCamera.camera.lisenter.ReturnLisenter;
import com.mysheng.office.kkanshop.customCamera.camera.lisenter.TypeLisenter;
import com.mysheng.office.kkanshop.customCamera.camera.util.AutoVBRMode;
import com.mysheng.office.kkanshop.customCamera.dialog.LoadingDialog;
import com.mysheng.office.kkanshop.customCamera.model.LocalMediaCompress;
import com.mysheng.office.kkanshop.customCamera.model.LocalMediaConfig;
import com.mysheng.office.kkanshop.customCamera.model.OnlyCompressOverBean;
import com.mysheng.office.kkanshop.customCamera.util.Constant;
...
public class JCameraView extends FrameLayout implements CameraInterface.CamOpenOverCallback, SurfaceHolder.Callback {
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconLight=a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.light_close);
    ...
    private void initView() {
        ...
        //switchLight
        mSwitchLight = new ImageView(mContext);
        iconSize = 3 * iconSize / 4;
        LayoutParams lightParam = new LayoutParams(iconSize + 2 * iconMargin, iconSize + 3 * iconMargin);
        mSwitchLight.setPadding(iconMargin, 3 * iconMargin / 2, iconMargin, iconMargin);
        mSwitchLight.setLayoutParams(lightParam);
        mSwitchLight.setImageResource(R.drawable.light_close);
...
//                }
        ...
        imageViewParam.gravity = Gravity.END;
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureLisenter() {
            ...
            public void takePictures() {
                ...
                CameraInterface.getInstance().takePicture(new CameraInterface.TakePictureCallback() {
                    ...
                    public void captureResult(Bitmap bitmap, boolean isVertical) {
                        ...
                        mSwitchLight.setVisibility(INVISIBLE);
            ...
            public void recordShort(long time) {
                ...
                mSwitchLight.setRotation(0);
                mSwitchCamera.setVisibility(VISIBLE);
                mSwitchLight.setVisibility(VISIBLE);
                CameraInterface.getInstance().setSwitchView(mSwitchLight);
            ...
            public void recordStart() {
                ...
                mSwitchLight.setVisibility(GONE);
