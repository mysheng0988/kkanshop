package com.mysheng.office.kkanshop.ImageViewer.view;
...
public class RingLoadingView extends View {
    private static final float DEFAULT_SIZE = KkanApplication.dpToPx(48);
    private final Paint mPaint = new Paint();
    private float mStrokeWidth = KkanApplication.dpToPx(1);
    ...
    private void init() {
        ...
        mProgressBounds.inset(KkanApplication.dpToPx(6), KkanApplication.dpToPx(6));
